...
"border-color: rgb(0, 0, 0);"));
        PINsymbol_lineEdit->setAlignment(Qt::AlignHCenter|Qt::AlignTop);
        KeyPad = new QGroupBox(PinUIMoottoriDialog);
        KeyPad->setObjectName(QStringLiteral("KeyPad"));
        KeyPad->setGeometry(QRect(210, 150, 811, 551));
        KeyPad->setStyleSheet(QLatin1String("background-color: rgb(132, 132, 132);\n"
"border: 2px solid;\n"
"border-color: rgb(97, 97, 97);"));
        pinButtonEmpty_2 = new QPushButton(KeyPad);
        pinButtonEmpty_2->setObjectName(QStringLiteral("pinButtonEmpty_2"));
        pinButtonEmpty_2->setGeometry(QRect(371, 401, 130, 90));
        pinButtonEmpty_2->setMinimumSize(QSize(130, 90));
        pinButtonEmpty_2->setMaximumSize(QSize(130, 90));
        pinButtonEmpty_2->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);"));
        ...
        pinButton8->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 6px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton6->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton7->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton3->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton9->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton5->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton1->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        pinButtonEmpty = new QPushButton(KeyPad);
        pinButtonEmpty->setObjectName(QStringLiteral("pinButtonEmpty"));
        pinButtonEmpty->setGeometry(QRect(71, 401, 130, 90));
        pinButtonEmpty->setMinimumSize(QSize(130, 90));
        pinButtonEmpty->setMaximumSize(QSize(130, 90));
        pinButtonEmpty->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);"));
        ...
        pinButton2->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton4->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        ...
        pinButton0->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"font: 26pt \"Arial\";"));
        pinButtonCancel = new QPushButton(KeyPad);
        pinButtonCancel->setObjectName(QStringLiteral("pinButtonCancel"));
        pinButtonCancel->setGeometry(QRect(591, 71, 150, 90));
        pinButtonCancel->setMinimumSize(QSize(150, 90));
        pinButtonCancel->setMaximumSize(QSize(150, 90));
        pinButtonCancel->setAutoFillBackground(false);
        pinButtonCancel->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
...
"font: 18pt \"Arial\";"));
        ...
        pinButtonOk->setGeometry(QRect(591, 291, 150, 90));
        pinButtonOk->setMinimumSize(QSize(150, 90));
        pinButtonOk->setMaximumSize(QSize(150, 90));
        pinButtonOk->setAutoFillBackground(false);
        pinButtonOk->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
...
"font: 26pt \"Arial\";"));
        ...
        pinButtonClear->setGeometry(QRect(591, 181, 150, 90));
        pinButtonClear->setMinimumSize(QSize(150, 90));
        pinButtonClear->setMaximumSize(QSize(150, 90));
        pinButtonClear->setAutoFillBackground(false);
        pinButtonClear->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(255, 255, 65);\n"
"font: 18pt \"Arial\";"));
        pinButtonEmpty_3 = new QPushButton(KeyPad);
        pinButtonEmpty_3->setObjectName(QStringLiteral("pinButtonEmpty_3"));
        pinButtonEmpty_3->setGeometry(QRect(591, 401, 150, 90));
        pinButtonEmpty_3->setMinimumSize(QSize(150, 90));
        pinButtonEmpty_3->setMaximumSize(QSize(150, 90));
        pinButtonEmpty_3->setStyleSheet(QLatin1String("border: 1px solid;\n"
"border-color: rgb(97, 97, 97);\n"
"border-radius: 8px;\n"
"background-color: rgb(221, 221, 221);\n"
"enabled background-color: rgb(110, 110, 110);"));
        ...
        PINinput_lineEdit = new QLineEdit(PinUIMoottoriDialog);
        PINinput_lineEdit->setObjectName(QStringLiteral("PINinput_lineEdit"));
        PINinput_lineEdit->setGeometry(QRect(120, 70, 113, 22));

        retranslateUi(PinUIMoottoriDialog);

        pinButtonCancel->setDefault(false);
    ...
    void retranslateUi(QDialog *PinUIMoottoriDialog)
    {
        ...
        PINsymbol_lineEdit->setText(QApplication::translate("PinUIMoottoriDialog", "****", Q_NULLPTR));
        KeyPad->setTitle(QString());
        pinButtonEmpty_2->setText(QString());
        ...
        pinButtonEmpty->setText(QString());
        ...
        pinButtonCancel->setText(QApplication::translate("PinUIMoottoriDialog", "CANCEL", Q_NULLPTR));
        ...
        pinButtonEmpty_3->setText(QApplication::translate("PinUIMoottoriDialog", "TESTI!! PAINA", Q_NULLPTR));
